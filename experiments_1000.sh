...
python3 /Users/ftesone/dev/big_data_text_similarity/confusion_matrix_ensembles.py -runs 10 -sample_size 1000 -experiment_path "$RESULTS_FOLDER/$ORIGIN_FOLDER"
