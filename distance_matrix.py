...
if __name__ == '__main__':
    ...
    parser = ArgumentParser('Computes the distance among all the questions')
    ...
    for run in range(1, runs + 1):
        ...
        with open(results_path, 'w') as results_file:
            ...
            for i, row in enumerate(index_questions):
                logging.info('Comparing ' + str(i + 1) + ' of ' + str(sample_size * 2))
        ...
        logging.info("Run " + str(run) + " finished")
